...
namespace EFCodeFirstApp.DAL
{
    public partial class AppDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("server=localhost;database=NorthwindCodeFirst;integrated security=true;trusted_connection=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasIndex(e => new { e.CompanyName, e.Phone }, "SearchByNameAndPhone");

                entity.HasIndex(e => e.Phone, "SearchByPhone");

                entity.HasIndex(e => e.CompanyName, "SearchbyCompanyName");
